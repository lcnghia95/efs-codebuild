...
export async function setContext(app, context) {
  ...
  if (!app.context) {
    app.context = {
      ...
      error: context.error,
      base: '/',
      env: {"NODE_ENV":"staging","BLOG_URL":"https://blog.gogojungle.net","FACEBOOK_CLIENT_ID":2005713583007594,"FXON_URL":"https://fx-on.gogojungle.net","GOGO_DOMAIN":".gogojungle.net","GOGO_URL":"https://www.gogo.gogojungle.net","KABU_API_URL":"http://internal-api.gogojungle.net","MOBILE_SUPPORT_URL":"^/$,^/(tools|systemtrade|finance|users|kabu-api|post|review|info|markets|event|crowdsourcing|products|terms)(/.+)?$,^/(login|logout|register|password/reset|companies|newcampaign|inquiry)$","MYPAGE_URL":"http://internal-api.gogojungle.net:81","NATS_SSL":null,"NATS_URL":null,"NEW_API_URL":"http://internal-api.gogojungle.net","RE_API_URL":"http://internal-api.gogojungle.net","REAL_TRADE_URL":"https://real-trade.gogojungle.com","SLACK_CHANNEL":"error-test","SLACK_HOOK_URL":"https://hooks.slack.com/services/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","ENC_KEY":"_gogo+jungle$$shisaitettei!#NG","FXON_BLOG_URL":"https://fx-blog.gogojungle.net"}
    }
    // Only set once
