  ...
  <div class="auth-Ht7WL" @keyup.enter="onSubmitLogin">
    <div v-if="!userTypes.length || userTypes.length === 1">
      ...
      <div class="flex title-border-bottom pb-10">
        <div class="register-by-email">
          ...
          <div class="reset">
            &#x25B8;
            <a :href="`${prefixUrl}/password/reset`">
              {{ $t('6') }}
            </a>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="social-block flex mid mt-20">
            ...
            <a
              id="twitter"
              class="pl-10 pr-40 w-full fs-12 co-black no-underlying" rel="nofollow"
      ...
      <div>
        ...
        <a class="register-link" :href="`${prefixUrl}/register?${buildGetParams()}`">
    ...
    <div v-else>
      ...
      >
        ...
        <div type="text" class="input-border user-type-input h-40 w-full">
