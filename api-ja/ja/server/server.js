...
async function fn() {
  ...
  // Todo Trung Pham - Remove the following require & server/utils/cart-log.js
  require('@@server/utils/cart-log')('cart', 'calg')
  ...
  require('@server/middlewares/affiliate')(app)
  ...
  app.use(logger(
    ':remote-addr ":method :url HTTP/:http-version" :status :response-time ms :res[content-length] ":referrer" ":user-agent"',
    {
